...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TanxSDKBinary",
            url: "https://github.com/RevinSun/TanxSDK-GitHub-SPM/releases/download/3.7.26/TanxSDK.xcframework.zip",
            checksum: "0f18002f09c409a5d977cae8e40298374be6ea41fff4044f17bc73f81fc06df4"
        ),
        .binaryTarget(
            name: "TNXASDK",
            url: "https://github.com/RevinSun/TanxSDK-GitHub-SPM/releases/download/3.7.26/TNXASDK.xcframework.zip",
            checksum: "0bfe2bb2a8843394c0a3eca7652fe580e0c404a07f2b18f4d71e9b0999d04938"
        ),
        .binaryTarget(
            name: "TanxMonitor",
            url: "https://github.com/RevinSun/TanxSDK-GitHub-SPM/releases/download/3.7.26/TanxMonitor.xcframework.zip",
